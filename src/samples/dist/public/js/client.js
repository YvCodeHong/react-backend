...
exports.withDataProvider = exports.WithData = exports.NoDataNeed = exports.NeedsData = exports.ProviderRules = exports.default = undefined;

var _DataProvider = __webpack_require__(79);

var _DataProvider2 = _interopRequireDefault(_DataProvider);

var _ProviderRules = __webpack_require__(37);

var _ProviderRules2 = _interopRequireDefault(_ProviderRules);

var _NeedsData = __webpack_require__(80);

var _NeedsData2 = _interopRequireDefault(_NeedsData);

var _NoDataNeed = __webpack_require__(81);

var _NoDataNeed2 = _interopRequireDefault(_NoDataNeed);

var _WithData = __webpack_require__(82);

var _WithData2 = _interopRequireDefault(_WithData);

var _withDataProvider = __webpack_require__(83);

var _withDataProvider2 = _interopRequireDefault(_withDataProvider);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _DataProvider2.default;
exports.ProviderRules = _ProviderRules2.default;
exports.NeedsData = _NeedsData2.default;
exports.NoDataNeed = _NoDataNeed2.default;
exports.WithData = _WithData2.default;
exports.withDataProvider = _withDataProvider2.default;
...
function renderChildren(props) {
  if (props.children) return props.children;else return null;
}
...
exports.containsReload = containsReload;
exports.withoutReload = withoutReload;
...
var ProviderRules = function (_Component) {
  ...
  _createClass(ProviderRules, [{
    ...
    value: function render() {
      ...
      if (serverSide) return (0, _utilities.renderChildren)(this.props);

      return _react2.default.createElement(_reactRouterDom.Route, { render: function render(_ref) {
          var location = _ref.location;
          return (0, _utilities.containsReload)(location) ? (0, _utilities.renderChildren)(_this2.props) : null;
        } });
    }
  }]);
...
var _ClientDataProvider = __webpack_require__(78);

var _ClientDataProvider2 = _interopRequireDefault(_ClientDataProvider);

var _DataNeeds = __webpack_require__(84);
...
var dataProvider = new _ClientDataProvider2.default();
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_DataNeeds2.default, null)
    ),
    _react2.default.createElement(
      WithData,
      { dataProvider: dataProvider },
...
var ClientDataProvider = function (_DataProvider) {
  _inherits(ClientDataProvider, _DataProvider);

  function ClientDataProvider() {
    _classCallCheck(this, ClientDataProvider);

    return _possibleConstructorReturn(this, (ClientDataProvider.__proto__ || Object.getPrototypeOf(ClientDataProvider)).apply(this, arguments));
  }

  _createClass(ClientDataProvider, [{
    key: "getUserId",
    ...
    value: function getUser() {
      ...
      // you could call your REST API here
      function (id) {
...
exports.default = ClientDataProvider;
...
var DataProvider = function () {
  ...
  _createClass(DataProvider, [{
     ...
     * @returns {Promise} A promise concatenating all the needs of your components.
     */
    value: function resolveNeeds() {
      ...
      var result = Promise.all(resolvers).then(function () {
        var values = {};
        var errors = {};
        var _iteratorNormalCompletion = true;
        var _didIteratorError = false;
...
/** 
 * NoDataNeed is just an empty element, in order to remember you that 
 * the current route does not need any more data
 */
function NoDataNeed() {
  return null;
}

exports.default = NoDataNeed;
...
var _ProviderRules2 = __webpack_require__(37);
...
var WithData = function (_ProviderRules) {
  ...
  _createClass(WithData, [{
    ...
    value: function shouldComponentUpdate() {
      ...
      var shouldReload = (0, _utilities.containsReload)(document.location);
    ...
    value: function render() {
      ...
      if (!WithData.enableServerRendering) return null;

      return _react2.default.createElement(_reactRouterDom.Route, { render: function render(_ref) {
          var location = _ref.location;
          return !(0, _utilities.serverSide)() && (0, _utilities.containsReload)(location) ? _react2.default.createElement(_reactRouterDom.Redirect, { to: (0, _utilities.withoutReload)(location) }) : _this2.props.children;
        }
      });
    }
  }], [{
    key: 'enableServerRendering',
    get: function get() {
      return !WithData.__STOP__;
    },
    set: function set(value) {
      WithData.__STOP__ = !value;
    }
  }]);
...
function withDataProvider(Wrapped) {
  var WDP = function (_Component) {
    _inherits(WDP, _Component);

    function WDP() {
      _classCallCheck(this, WDP);

      return _possibleConstructorReturn(this, (WDP.__proto__ || Object.getPrototypeOf(WDP)).apply(this, arguments));
    }

    _createClass(WDP, [{
      key: 'render',
      value: function render() {
        var dataProvider = this.context.dataProvider;

        var newProps = Object.assign({}, { dataProvider: dataProvider }, this.props);
...
function DataNeeds() {
  return _react2.default.createElement(
    _react.Fragment,
    null,
    _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _.NoDataNeed }),
    _react2.default.createElement(_reactRouterDom.Route, { path: '/params', render: function render() {
        return _react2.default.createElement(
          _.NeedsData,
          { needs: 'getUserId' },
          _react2.default.createElement(_reactRouterDom.Route, { path: '/params/account', render: function render() {
              return _react2.default.createElement(_.NeedsData, { needs: 'getUser' });
            } }),
          _react2.default.createElement(_reactRouterDom.Route, { path: '/params/profile', component: _.NoDataNeed })
        );
      } })
  );
}

exports.default = DataNeeds;
...
var HomePage = (0, _.withDataProvider)(function (props) {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(
    ...
    _react2.default.createElement(
      'p',
      null,
      'There is no data associated to this route'
    )
  );
});

var ParamsPage = (0, _.withDataProvider)(function (props) {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(
    ...
    _react2.default.createElement(
      'p',
      null,
      'We can read getUserId from the dataprovider : ',
      props.dataProvider.getData('getUserId')
    )
  );
});

var AccountPage = (0, _.withDataProvider)(function (props) {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(
    ...
    _react2.default.createElement(
      'p',
      null,
      'We can read getUser from the dataprovider : ',
      JSON.stringify(props.dataProvider.getData('getUser'))
    ),
    _react2.default.createElement(
      'p',
      null,
      'As well as getUserId : ',
      props.dataProvider.getData('getUserId')
    )
  );
});

var ProfilePage = (0, _.withDataProvider)(function (props) {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(
    ...
    _react2.default.createElement(
      'p',
      null,
      'We can only read getUserId from the dataprovider : ',
      props.dataProvider.getData('getUserId')
    )
  );
});
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/params', component: ParamsPage }),
          _react2.default.createElement(_reactRouterDom.Route, { path: '/params/account', component: AccountPage }),
          _react2.default.createElement(_reactRouterDom.Route, { path: '/params/profile', component: ProfilePage })
        )
      );
    }
  }]);
